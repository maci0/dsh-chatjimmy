...
const CONFIGURED_MODEL_DESCRIPTION = 'Taalas-hosted Llama 3.1 8B served by chatjimmy.ai. Text only: no tool calls, no images, 6144-token total context.';
/**
 ...
 */
export function finishReasonFor(stats) {
